...
public class Ranking {
    ...
    public static void main(String[] args) {
        ...
        while(!inputLine.equals("end of submissions")){
            ...
            if(passwordByContest.containsKey(contest)&& password.equals(passwordByContest.get(contest))){
                User user=new User(contest,password,points);
                if(users.isEmpty()){
                    users.add(user);
                }else{
        ...
        Map<String,List<User>> collect=users.stream().collect(Collectors.groupingBy(user->user.getUser()));
        ...
        String bestUser=Collections.max(usersByPoints.entrySet(),
